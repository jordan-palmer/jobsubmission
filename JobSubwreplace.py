...
class jobSubmitter(object):
    ...
    def writeJobBash(self, filetorun):
        ...
        line5 = self.cmd + " " + self.jobDirName+"/"+filetorun#self.tempfile#filetorun#self.inFile
    ...
    def jobSubmit(self,err_file, log_file):
        ...
        sub.call(["qsub","-q","long","-l","pvmem=8gb","-o",log_file,"-e",err_file, self.jobScript])#jobName])
